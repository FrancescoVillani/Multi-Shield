...
# Custom trained models (example configurations)
# Note: These paths are placeholders. Users need to train their own models.
# See training notebooks or train from scratch using torchvision models.
cifar10_resnet50 = {
    'path': "pretrained_models/custom/resnet50_cifar10.pth",
    'model_type': torchvision.models.resnet50,
    'new_num_classes': 10
}
cifar10_wideresnet50 = {
    'path': "pretrained_models/custom/wide_resnet50_2_cifar10.pth",
    'model_type': torchvision.models.wide_resnet50_2,
    'new_num_classes': 10
}

_local_cifar_models = {
    "cifar10_resnet50": partial(load_local_model, path=cifar10_resnet50["path"],
                                   model_type=cifar10_resnet50["model_type"],
                                   new_num_classes=cifar10_resnet50["new_num_classes"]),
    "cifar10_wideresnet50": partial(load_local_model, path=cifar10_wideresnet50["path"],
                                   model_type=cifar10_wideresnet50["model_type"],
                                   new_num_classes=cifar10_wideresnet50["new_num_classes"]),
...
# Caltech-101 custom models (example configurations)
# Note: These paths are placeholders. Train your own models if needed.
caltech101_resnet50 = {
    'path': "pretrained_models/custom/resnet50_caltech101.pth",
    'model_type': torchvision.models.resnet50,
    'new_num_classes': 101
}
caltech101_wideresnet50 = {
    'path': "pretrained_models/custom/wide_resnet50_2_caltech101.pth",
    'model_type': torchvision.models.wide_resnet50_2,
    'new_num_classes': 101
}
...
_local_caltech101_models = {
    "caltech101_resnet50": partial(load_local_model, path=caltech101_resnet50["path"],
                                   model_type=caltech101_resnet50["model_type"],
                                   new_num_classes=caltech101_resnet50["new_num_classes"]),
    "caltech101_wideresnet50": partial(load_local_model, path=caltech101_wideresnet50["path"],
                                   model_type=caltech101_wideresnet50["model_type"],
                                   new_num_classes=caltech101_wideresnet50["new_num_classes"])
}



# STL-10 custom models (example configurations)
# Note: These paths are placeholders. Train your own models if needed.
stl10_resnet50 = {
    'path': "pretrained_models/custom/resnet50_stl10.pth",
    'model_type': torchvision.models.resnet50,
    'new_num_classes': 10
}
stl10_wideresnet50 = {
    'path': "pretrained_models/custom/wide_resnet50_2_stl10.pth",
    'model_type': torchvision.models.wide_resnet50_2,
    'new_num_classes': 10
}
...
_local_stl10_models = {
    "stl10_resnet50": partial(load_local_model, path=stl10_resnet50["path"],
                                   model_type=stl10_resnet50["model_type"],
                                   new_num_classes=stl10_resnet50["new_num_classes"]),
    "stl10_wideresnet50": partial(load_local_model, path=stl10_wideresnet50["path"],
                                   model_type=stl10_wideresnet50["model_type"],
                                   new_num_classes=stl10_wideresnet50["new_num_classes"])
}

# Food-101 custom models (example configurations)
# Note: These paths are placeholders. Train your own models if needed.
food101_resnet50 = {
    'path': "pretrained_models/custom/resnet50_food101.pth",
    'model_type': torchvision.models.resnet50,
    'new_num_classes':  101
}
food101_wideresnet50 = {
    'path': "pretrained_models/custom/wide_resnet50_2_food101.pth",
    'model_type': torchvision.models.wide_resnet50_2,
    'new_num_classes':  101
}
...
_local_food101_models = {
    "food101_resnet50": partial(load_local_model, path=food101_resnet50["path"],
                                   model_type=food101_resnet50["model_type"],
                                   new_num_classes=food101_resnet50["new_num_classes"]),
    "food101_wideresnet50": partial(load_local_model, path=food101_wideresnet50["path"],
                                   model_type=food101_wideresnet50["model_type"],
                                   new_num_classes=food101_wideresnet50["new_num_classes"])
}


# Oxford-IIIT Pets custom models (example configurations)
# Note: These paths are placeholders. Train your own models if needed.
pets_resnet50 = {
    'path': "pretrained_models/custom/resnet50_pets.pth",
    'model_type': torchvision.models.resnet50,
    'new_num_classes':  37
}
pets_wideresnet50 = {
    'path': "pretrained_models/custom/wide_resnet50_2_pets.pth",
    'model_type': torchvision.models.wide_resnet50_2,
    'new_num_classes':  37
}
...
_local_pets_models = {
    "pets_resnet50": partial(load_local_model, path=pets_resnet50["path"],
                                   model_type=pets_resnet50["model_type"],
                                   new_num_classes=pets_resnet50["new_num_classes"]),
    "pets_wideresnet50": partial(load_local_model, path=pets_wideresnet50["path"],
                                   model_type=pets_wideresnet50["model_type"],
                                   new_num_classes=pets_wideresnet50["new_num_classes"])
}
