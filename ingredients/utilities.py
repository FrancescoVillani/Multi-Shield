...
def run_predictions(
    ...
    if rejection_class:
        clean_accuracy = sum(
            [pred_labels[i] == true_labels[i] for i in range(len(true_labels))]
        ) / len(true_labels)
        adv_acc = sum(
            [
                adv_pred_labels[i] == true_labels[i]
                or adv_pred_labels[i] == rejection_class
        ...
        adv_acc = sum(
            [adv_pred_labels[i] == true_labels[i] for i in range(len(true_labels))]
        ) / len(true_labels)
